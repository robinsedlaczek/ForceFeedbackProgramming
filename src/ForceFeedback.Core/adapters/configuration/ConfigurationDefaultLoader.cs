...
namespace ForceFeedback.Core.adapters.configuration
{
    ...
    {
        private const string DEFAUL_CONFIGURATION_RESOURCE_NAME = "ConfigurationDefaults.json";
        ...
        internal static string Load_embedded_resource_text(string resourceName, Assembly assembly = null) {
